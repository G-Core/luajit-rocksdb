...
static int lrocksdb_open_with_cf(lua_State *L);
static int lrocksdb_put_with_cf(lua_State *L);
static int lrocksdb_get_with_cf(lua_State *L);
...
static const struct luaL_Reg  lrocksdb_db_reg[] = {
  { "put_with_cf", lrocksdb_put_with_cf},
  { "put", lrocksdb_put },
  { "close", lrocksdb_close },
  { "get_with_cf", lrocksdb_get_with_cf },
  { "get", lrocksdb_get },
...
static const struct luaL_Reg lrocksdb_funcs[] = {
  { "open_with_cf", lrocksdb_open_with_cf },
  { "open", lrocksdb_open },
...
int lrocksdb_open_with_cf(lua_State* L){
